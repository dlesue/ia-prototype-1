      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <ul className="flex flex-col gap-2">
            {[
              "Industry-specific benchmarks for 50+ HR metrics",
              "Filter by company size, industry, and geography",
              "Percentile ranking relative to peer companies",
              "Trend data showing benchmark shifts over time",
            ].map((f, i) => (
        ...
        <div className="relative rounded-[var(--radius-large)] border border-[var(--border-neutral-xx-weak)] overflow-hidden">
          <div className="absolute inset-0 backdrop-blur-sm bg-white/60 z-10 flex flex-col items-center justify-center gap-3">
            ...
            <span className="text-sm font-medium text-[var(--text-neutral-medium)]">Upgrade to unlock industry benchmarks</span>
          </div>
