...
export default function SettingsHub() {
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold text-[var(--text-neutral-xx-strong)] mb-1">Settings</h1>
      <h2 className="text-lg font-semibold text-[var(--text-neutral-xx-strong)] mb-4">Account</h2>

      <div className="max-w-3xl">
        <p className="text-sm text-[var(--text-neutral-medium)] mb-6">Manage your BambooHR subscription and company settings</p>

        <div className="flex flex-col gap-5">
          <div className="bg-[var(--surface-neutral-white)] rounded-[var(--radius-large)] border border-[var(--border-neutral-xx-weak)] p-5">
            <h3 className="text-sm font-semibold text-[var(--text-neutral-xx-strong)] mb-4">Subscription</h3>
          ...
          <div className="bg-[var(--surface-neutral-white)] rounded-[var(--radius-large)] border border-[var(--border-neutral-xx-weak)] p-5">
            <h3 className="text-sm font-semibold text-[var(--text-neutral-xx-strong)] mb-4">Company Information</h3>
          ...
          <div className="bg-[var(--surface-neutral-white)] rounded-[var(--radius-large)] border border-[var(--border-neutral-xx-weak)] p-5">
            <h3 className="text-sm font-semibold text-[var(--text-neutral-xx-strong)] mb-4">Login &amp; Security</h3>
