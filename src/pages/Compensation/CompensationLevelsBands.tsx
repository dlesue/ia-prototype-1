...
export default function CompensationLevelsBands() {
  return (
    <UpsellPage
      title="Levels & Bands"
      description="Define compensation bands for each level and role in your organization. Ensure consistent and fair pay structures that scale with your company."
      features={[
                "Create custom job levels and grade structures",
        "Set pay band minimums, midpoints, and maximums",
        "Visual band overlap and compression analysis",
        "Employee placement within band visualization",
      ]}
      previewLabel="compensation bands"
    />
  );
}
