  ...
  return (
    <div className="p-6">
      <div className="max-w-2xl mx-auto">
        ...
        <h1 className="text-2xl font-bold text-[var(--text-neutral-xx-strong)] mb-4">Planning</h1>
...
export default function CompensationPlanning() {
  return (
    <UpsellPage
      ...
      description="Run merit cycles, bonus allocations, and equity grants with full manager collaboration and budget controls. Streamline your entire comp planning process."
      features={[
                "Merit and bonus cycle management with approval workflows",
        "Budget waterfall and manager allocation tools",
        "Equity grant planning and vesting schedule tracking",
        "Automated offer letter generation with approved ranges",
      ]}
      previewLabel="compensation planning"
    />
  );
}
