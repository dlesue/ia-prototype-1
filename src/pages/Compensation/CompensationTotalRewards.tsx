  ...
  return (
    <div className="p-6">
      <div className="max-w-2xl mx-auto">
        ...
        <h1 className="text-2xl font-bold text-[var(--text-neutral-xx-strong)] mb-4">Total Rewards</h1>
...
export default function CompensationTotalRewards() {
  return (
    <UpsellPage
      title="Total Rewards"
      description="Give employees full visibility into their total compensation value including salary, equity, benefits, and perks. Improve offer acceptance and retention."
      features={[
                "Personalized total rewards statements for every employee",
        "Real-time equity value calculations and vesting progress",
        "Benefits cost breakdown and employer contribution visibility",
        "Shareable total compensation summaries for candidates",
      ]}
      previewLabel="total rewards statements"
    />
  );
}
